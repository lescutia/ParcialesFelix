 ...
 * @author gamaa
 */
public class LeaderSearchGUI extends javax.swing.JFrame {

    /**
     * Creates new form LeaderSearchGUI
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LeaderSearchGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LeaderSearchGUI().setVisible(true);
            }
        });
    }
